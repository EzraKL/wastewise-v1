// pages/dashboard.js (FINAL OPTIMIZED VERSION)
...
export default function DashboardPage() {
    ...
    useEffect(() => {
        ...
        const fetchDashboardData = async () => {
            ...
            try {
                ...
                const data = await res.json();
                if (data.success) {
                    // Store the raw unified data for filtering below
    ...
    const completedPurchases = transactions.filter(tx => 
        // Filter for transactions where the current user is the buyer AND the transaction is complete
            ...
            <div className="bg-white shadow-lg rounded-xl p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    ...
                    <div className="bg-yellow-50 p-6 rounded-lg border border-yellow-200 flex flex-col justify-between">
                        ...
                        <Link href="/dashboard/transactions" legacyBehavior passHref> 
                    ...
                    {isSellerRole && (
                        <div className="bg-green-50 p-6 rounded-lg border border-green-200 flex flex-col justify-between">
                            ...
                            <Link href="/dashboard/create-listing" legacyBehavior passHref>
